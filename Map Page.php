...
?>
        <!--Start of Map Container Main Code-->
        <body>
        <section class="main-container">
            <header class="header-main">
                <!--Pizza House Header With Images-->
                <img src="https://assets.stickpng.com/images/58738081f3a71010b5e8ef3a.png" height="40px">
                Pizza House
                <img src="https://assets.stickpng.com/images/58738081f3a71010b5e8ef3a.png" height="40px">
            </header>
                                <!--Title for page-->
            ...
            <!--Top Navigation Bar Main Code-->
                   ...
                   width="100%" height="600" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-whendowngrade"></iframe>
                    </main>
                   <!--Address Bar-->
